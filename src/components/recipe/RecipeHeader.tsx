...
export default function RecipeHeader({ recipe }: { recipe: IRecipeData }) {
  return (
    <div
      style={{
      ...
      className={`opacity-1/2 relative overflow-hidden bg-gray-600/50 bg-cover bg-center bg-no-repeat pb-4 bg-blend-overlay`}
    >
